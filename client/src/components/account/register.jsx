...
//         console.log('FormData to send before appending fields:', formDataToSend);
...
//         formDataToSend.append('code_of_conduct_agreed', formData.code_of_conduct_agreed);
...
//             }
//         });
//         console.log('FormData to send after appending fields:', formDataToSend);

//         // console.log('Submitting registration with documents:', documents.length);
//         // console.log('Documents map:', documentsMap);
//         // console.log('FormData to send111111111:', formDataToSend);
...
//         // console.log('Register response status:', formDataToSend);
...
//     const handleDocumentSubmitOld = async () => {
//         if (documents.length === 0) {
//             addToast('Error', 'Please upload at least one document');
//             return;
//         }
...
//                                                         <p className="text-sm text-gray-500">
//                                                             Drag and drop your {doc.type.toLowerCase()} here, or click the button below
//                                                         </p>
//                                                         <Button
//                                                             type="button"
//                                                             onClick={() => document.getElementById(`file-upload-individual-${index}`).click()}
...
//                                         {/* Drag and Drop Overlay (only when not uploaded) */}
//                                         {!doc.uploaded && (
//                                             <div 
//                                                 className="absolute inset-0 bg-blue-50 bg-opacity-0 hover:bg-opacity-30 transition-all duration-300 rounded-lg flex items-center justify-center opacity-0 hover:opacity-100"
//                                                 onDrop={(e) => {
//                                                     e.preventDefault();
//                                                     const files = e.dataTransfer.files;
//                                                     if (files.length > 0) {
//                                                         const fakeEvent = { target: { files: files } };
//                                                         handleFileUpload(fakeEvent, index);
//                                                     }
//                                                 }}
