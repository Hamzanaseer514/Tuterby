...
const Register = () => {
  ...
  const handleAvailabilityChange = (day, isChecked) => {
    setFormData((prev) => {
      ...
      if (!selectedDuration) {
        addToast(
          "Error",
          "Please select a session duration before adding availability"
        );
        return prev;
      }
      return {
  ...
  const handleFileUpload = (e, index) => {
    ...
    if (file) {
      ...
      addToast(
        "Success",
        `${file.name} uploaded successfully for ${currentDocType}`
      );
      e.target.value = "";
      ...
      if (index < requiredDocuments.length - 1) {
        ...
        setTimeout(() => {
          addToast(
            "Success",
            "All documents uploaded! You can now complete registration."
          );
        }, 500);
      }
    }
  ...
  const handleDocumentCompletion = () => {
    ...
    addToast(
      "Success",
      "All documents uploaded successfully! You can now complete your registration."
    );
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (activeTab === "tutor") {
      ...
      if (tutorStep === 3 && documentsCompleted) {
        ...
        try {
          ...
          formDataToSend.append(
            "subjects",
            JSON.stringify(formData.subjects_taught)
          );
          formDataToSend.append(
            "academic_levels_taught",
            JSON.stringify(formData.academic_levels_taught)
          );
          ...
          documents.forEach((doc, index) => {
            if (doc.content) {
              ...
              const uniqueFileName = `${doc.type.replace(
                /\s+/g,
                "_"
              )}_${Date.now()}_${index}.${fileExtension}`;
          ...
          if (!registerResponse.ok) {
            throw new Error(
              registerData.message || "Tutor registration failed"
            );
          }

          addToast(
            "Registration Successful",
            `Welcome, ${formData.full_name}! Your account has been created as a tutor.`
          );
    ...
    try {
      ...
      if (endpoint && payload) {
        ...
        addToast(
          "Registration Successful",
          `Welcome, ${formData.full_name}! Your account has been created as a ${activeTab}.`
        );
        setFormData({
          full_name: "",
          email: "",
          ...
          <Card className="shadow-xl border-0 rounded-2xl overflow-hidden">
            ...
            <CardContent className="p-8 pb-4 bg-gradient-to-br from-blue-50 to-red-50">
              <div className="flex justify-center mb-8">
                <div
                  className="inline-flex w-[70%] rounded-md shadow-sm"
                  role="group"
                >
                  <Button
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {activeTab === "student" && (
                    <div className="space-y-2">
                      <Label htmlFor="academic_level" className="text-gray-700">
                        Academic Level
                      </Label>
                      <Select
                      ...
                      <div className="flex items-center justify-center space-x-4">
                        <div
                          className={`flex items-center ${
                            tutorStep >= 1 ? "text-blue-600" : "text-gray-400"
                          }`}
                        >
                          <div
                        ...
                        <div
                          className={`w-12 h-0.5 ${
                            tutorStep >= 2 ? "bg-blue-600" : "bg-gray-300"
                          }`}
                        ></div>
                        <div
                          className={`flex items-center ${
                            tutorStep >= 2 ? "text-blue-600" : "text-gray-400"
                          }`}
                        >
                          <div
                            className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${
                        ...
                        <div
                          className={`w-12 h-0.5 ${
                            tutorStep >= 3 ? "bg-blue-600" : "bg-gray-300"
                          }`}
                        ></div>
                        <div
                          className={`flex items-center ${
                            tutorStep >= 3 ? "text-blue-600" : "text-gray-400"
                          }`}
                        >
                          <div
                            className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${
                      ...
                      <div className="flex items-start space-x-3 pt-2 mt-6">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            setFormData({
                              ...formData,
                              code_of_conduct_agreed: checked,
                            })
                          }
                        ...
                        <div className="space-y-1">
                          <Label
                            htmlFor="code_of_conduct_agreed"
                            className="text-gray-700 font-normal"
                          >
                            I agree to the tutor code of conduct
                          </Label>
                          <p className="text-sm text-gray-500">
                            By checking this box, you agree to maintain
                            professional standards and ethical behavior.
                          </p>
                        </div>
                      </div>
          ...
          >
            <DialogContent className="max-w-2xl rounded-xl">
              <DialogHeader>
                ...
                <p className="text-sm text-gray-500">
                  Step {index + 1} of {requiredDocuments.length}: Upload your{" "}
              ...
              <div className="space-y-6">
                ...
                <div
                  className={`rounded-lg transition-all duration-300 ${
                    doc.uploaded ? "bg-green-50 border-green-200" : "bg-gray-50"
                  }`}
                >
                  <div
                    ...
                    onClick={() =>
                      document
                        .getElementById(`file-upload-individual-${index}`)
                        .click()
                    }
                  >
                    <input
                    ...
                    <div className="p-8 text-center">
                      <div
                        className={`p-4 rounded-full transition-all duration-300 mx-auto w-fit ${
                      ...
                      <div className="space-y-3 mt-4">
                        ...
                        {doc.uploaded ? (
                          ...
                          <div className="space-y-3">
                            <p className="text-sm text-gray-500">
                              Click anywhere in this area to select your{" "}
                              {doc.type.toLowerCase()} file
                            </p>
                            <div className="flex items-center justify-center gap-2 text-blue-600">
                              <Upload className="h-5 w-5" />
                              <span className="font-medium">
                                Click to Choose {doc.type} File
                              </span>
                            </div>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-center">
                    <div className="flex items-center justify-center gap-2 text-yellow-700">
                      ...
                      <p className="text-sm font-medium">
                        All {requiredDocuments.length} documents are required to
      ...
      {toasts.map(({ id, title, description }) => (
        ...
        >
          <div className="grid gap-1 p-4">
            {title && (
              <ToastTitle className="text-gray-800 font-medium">
                {title}
              </ToastTitle>
            )}
            {description && (
