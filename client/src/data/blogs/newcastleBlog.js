    ...
    content: [
      ...
      { type: 'paragraph', text: "Whether it's GCSE CS theory, A-Level programming projects (Python focus), or university-level data structures, TutorNearby connects Newcastle students with experienced CS tutors for online or in-person support. Enhance your Computer Science skills in Newcastle with our tailored UK curriculum help." },
      {
        ...
        faqs: [
          ...
          { question: "Can Computer Science tutoring help if I want to pursue a career in Newcastle's tech industry?", answer: "Definitely. Strong foundational CS skills are crucial for careers in software development, data science, cybersecurity, AI, and IT support – all growing sectors in Newcastle. Tutoring can help you build these skills and understand industry applications." },
