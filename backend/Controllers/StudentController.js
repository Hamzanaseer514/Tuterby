    ...
    try {
      ...
      if (min_hourly_rate || max_hourly_rate) {
        ...
        if (min_hourly_rate) {
          ...
          // Filter tutors whose maximum hourly rate is at least the minimum requested

          priceConditions.$expr = {

            $gte: [

              { $max: "$academic_levels_taught.hourlyRate" },

              parseFloat(min_hourly_rate)
        ...
        if (max_hourly_rate) {
          ...
          // Filter tutors whose minimum hourly rate is within budget

          const maxRateCondition = {
          ...
          if (priceConditions.$expr) {
            ...
            priceConditions.$expr = maxRateCondition;
        ...
        // Merge price conditions with existing query
